            ...
            <main className="step-main-content">
                ...
                <section className="step-list-section">
                    {curriculum.map((item) => (
                        <div
                            key={item.id}
                            className={`step-card ${item.status === 'done' ? 'card-done' : 'card-start'}`}
                        >
                            <div className="step-card-info">
                                ...
                                <div className="step-card-level">
                                    <span className={`level-dot ${item.status === 'done' ? 'dot-done' : 'dot-start'}`}></span>
                                    {item.level}
                                </div>
                            </div>

                            <button className={`step-action-btn ${item.status === 'done' ? 'btn-done' : 'btn-start'}`}>
